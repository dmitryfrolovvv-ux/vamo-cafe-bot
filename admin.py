...
class AdminStates(StatesGroup):
    ...
    editing_product_name_en = State()

    editing_product_name_ru = State()
    
    editing_product_name_tr = State()
    
    editing_product_description_en = State()
    
    editing_product_description_ru = State()
